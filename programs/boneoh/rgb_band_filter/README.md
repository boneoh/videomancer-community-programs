...
Matte Bit 2 (S2), Matte Bit 1 (S3), and Matte Bit 0 (S4) form a 3-bit word (S2 = MSB, S4 = LSB) that selects one of eight matte modes:
 ...
 ----  ----  ---- -------------- ------------- 
  ...
  1     0     1    LFSR           Matte = luma OR frame-locked noise (>>4), gated by logical OR  

  1     1     0    PRNG           Matte = luma OR line-seeded noise (>>4), gated by logical OR  
...
- **HD timing:** All six variants meet 74.25 MHz (worst case 77.72 MHz)
- **LC utilisation:** 4386–4420 of 7680 (~58%)
- **Package size:** 350,351 bytes (rev_b, unsigned)
